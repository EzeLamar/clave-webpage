...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footer: Schema.Attribute.Component<'layout.footer', false> &
      Schema.Attribute.Required;
    header: Schema.Attribute.Component<'layout.navbar', false> &
      Schema.Attribute.Required;
    isVisibleContactButton: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.hero', 'blocks.products', 'blocks.about-us', 'blocks.markdown']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'shared.item', true>;
